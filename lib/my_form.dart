...
class _MyFormState extends State<MyForm> {
  ...
  List<Truck> trucks = [
    Truck(imagePath: 'images/truck2-removebg-preview.png', name: 'Tipper', price: 500.0, weightCapacity: 4 - 30),
    Truck(imagePath: 'images/truck22 remove.png', name: ' Container', price: 600.0, weightCapacity: 4 - 30),
    Truck(imagePath: 'images/truck_3-removebg-preview.png', name: 'Open', price: 700.0, weightCapacity: 4 - 30),
    Truck(imagePath: 'images/truck_4-removebg-preview.png', name: 'Double Container', price: 800.0, weightCapacity: 1800.0),
    Truck(imagePath: 'images/truck_5-removebg-preview.png', name: 'Tanker', price: 900.0, weightCapacity: 2000.0),
  ];
